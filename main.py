...
def add_options():
  flags.DEFINE_enum('model', default = 'qwen2', enum_values = {'llama3', 'codellama', 'qwen2', 'codeqwen', 'qwen1.5'}, help = 'model to use')
  flags.DEFINE_enum('code_model', default = 'qwen2', enum_values = {'llama3', 'codellama', 'qwen2', 'codeqwen', 'qwen1.5'}, help = 'code generation model to use')

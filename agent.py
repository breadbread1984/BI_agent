...
class Agent(object):
  def __init__(self, model = 'llama3', tools = ["google-serper", "llm-math", "wikipedia", "arxiv"], locally = False):
    ...
    tools = load_tools(tools, llm = llm, serper_api_key = 'd075ad1b698043747f232ec1f00f18ee0e7e8663') + [load_knowledge_graph(password = '19841124'), load_database('bs_challenge_financial_14b_dataset/dataset/博金杯比赛数据.db')]
